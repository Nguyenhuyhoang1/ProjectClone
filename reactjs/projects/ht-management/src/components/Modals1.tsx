...
const App: React.FC = () => {
  ...
  return (
    ...
    <img  className="ImgPayment" src="https://monfin.vn/images/source/Congty/viettelpay.png" alt="" />
    </Button>
          ...
          <Col span={8} >
            <div className="Detail">
              <div className="Detail__item">
                ...
                <div className="">
                  <h3>Cổng thanh toán: <p>ViettelPay</p> </h3>
                </div>
                <hr />
                <div className="">
          ...
          <Col span={16}>
            <div className="QR">
              <div className="Header-img">
                <img style={{ width: 60, height: 60 }} src="https://monfin.vn/images/source/Congty/viettelpay.png" alt="" />
                <img style={{ width: 60, height: 60 }} src="https://monfin.vn/images/source/Congty/viettelpay.png" alt="" />
              </div>
              <hr />
              <div className="QR__code">
               ...
               <QRCode 
                  ...
                  icon="https://monfin.vn/images/source/Congty/viettelpay.png"
                />
               </div>
               <div className="" style={{margin : 20  }}>
               <QrcodeOutlined /> sử dụng App <strong>ViettlePay</strong> hoặc <br /> ứng dụng có Camera hỗ trợ QR code để quét mã
               </div>
               <div className="" style={{margin : 20}}>
              ...
              ------------------------------------------------------------------------  Hoặc  ----------------------------------------------------------------------------- 
               ...
               <div className="Login">
                Đăng kí tài khoản ViettelPay và thanh toán lần đầu hoặc <a href="">đăng nhập</a>
               </div>
